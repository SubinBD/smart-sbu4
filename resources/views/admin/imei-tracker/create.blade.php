        ...
        <div class="col-12">
            <div class="card mt-2">
                <div class="card-header">
                    <h3 class="card-title">Create New IMEI Tracker Entry</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.imei-tracker.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="source_name">Source Name</label>
                                    <input type="text" name="source_name" id="source_name" class="form-control @error('source_name') is-invalid @enderror" value="{{ old('source_name') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_date" id="product_date" class="form-control @error('product_date') is-invalid @enderror" value="{{ old('product_date') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pi_number" id="pi_number" class="form-control @error('pi_number') is-invalid @enderror" value="{{ old('pi_number') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="packing_list_number" id="packing_list_number" class="form-control @error('packing_list_number') is-invalid @enderror" value="{{ old('packing_list_number') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ean_upc_code" id="ean_upc_code" class="form-control @error('ean_upc_code') is-invalid @enderror" value="{{ old('ean_upc_code') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="item_sales" id="item_sales" class="form-control @error('item_sales') is-invalid @enderror" value="{{ old('item_sales') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="price_dp" id="price_dp" class="form-control @error('price_dp') is-invalid @enderror" value="{{ old('price_dp') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="price_rp" id="price_rp" class="form-control @error('price_rp') is-invalid @enderror" value="{{ old('price_rp') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="price_mrp" id="price_mrp" class="form-control @error('price_mrp') is-invalid @enderror" value="{{ old('price_mrp') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="model_name" id="model_name" class="form-control @error('model_name') is-invalid @enderror" value="{{ old('model_name') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="marketing_name" id="marketing_name" class="form-control @error('marketing_name') is-invalid @enderror" value="{{ old('marketing_name') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="device_type" id="device_type" class="form-control @error('device_type') is-invalid @enderror" value="{{ old('device_type') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="app_ref_hash" id="app_ref_hash" class="form-control @error('app_ref_hash') is-invalid @enderror" value="{{ old('app_ref_hash') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="country_of_origin" id="country_of_origin" class="form-control @error('country_of_origin') is-invalid @enderror" value="{{ old('country_of_origin') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="manufacturer_as_per_imei" id="manufacturer_as_per_imei" class="form-control @error('manufacturer_as_per_imei') is-invalid @enderror" value="{{ old('manufacturer_as_per_imei') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tac" id="tac" class="form-control @error('tac') is-invalid @enderror" value="{{ old('tac') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="no_of_sim" id="no_of_sim" class="form-control @error('no_of_sim') is-invalid @enderror" value="{{ old('no_of_sim') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="battery_capacity_tested" id="battery_capacity_tested" class="form-control @error('battery_capacity_tested') is-invalid @enderror" value="{{ old('battery_capacity_tested') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="charger_adapter_type" id="charger_adapter_type" class="form-control @error('charger_adapter_type') is-invalid @enderror" value="{{ old('charger_adapter_type') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="charger_output" id="charger_output" class="form-control @error('charger_output') is-invalid @enderror" value="{{ old('charger_output') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="rom" id="rom" class="form-control @error('rom') is-invalid @enderror" value="{{ old('rom') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="nfc" id="nfc" class="form-control @error('nfc') is-invalid @enderror">
                                        <option value="1" {{ old('nfc') == '1' ? 'selected' : '' }}>Yes</option>
                                        <option value="0" {{ old('nfc') == '0' ? 'selected' : '' }}>No</option>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bluetooth" id="bluetooth" class="form-control @error('bluetooth') is-invalid @enderror" value="{{ old('bluetooth') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="wlan" id="wlan" class="form-control @error('wlan') is-invalid @enderror" value="{{ old('wlan') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="data_speed_dl" id="data_speed_dl" class="form-control @error('data_speed_dl') is-invalid @enderror" value="{{ old('data_speed_dl') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="sar_value_w_kg" id="sar_value_w_kg" class="form-control @error('sar_value_w_kg') is-invalid @enderror" value="{{ old('sar_value_w_kg') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="rear_camera" id="rear_camera" class="form-control @error('rear_camera') is-invalid @enderror" value="{{ old('rear_camera') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="front_camera" id="front_camera" class="form-control @error('front_camera') is-invalid @enderror" value="{{ old('front_camera') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="camera_resolution_in_software" id="camera_resolution_in_software" class="form-control @error('camera_resolution_in_software') is-invalid @enderror" value="{{ old('camera_resolution_in_software') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="radio_interface" id="radio_interface" class="form-control @error('radio_interface') is-invalid @enderror" value="{{ old('radio_interface') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="supported_spectrum_bands_2g" id="supported_spectrum_bands_2g" class="form-control @error('supported_spectrum_bands_2g') is-invalid @enderror" value="{{ old('supported_spectrum_bands_2g') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="supported_spectrum_bands_3g" id="supported_spectrum_bands_3g" class="form-control @error('supported_spectrum_bands_3g') is-invalid @enderror" value="{{ old('supported_spectrum_bands_3g') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="supported_spectrum_bands_4g" id="supported_spectrum_bands_4g" class="form-control @error('supported_spectrum_bands_4g') is-invalid @enderror" value="{{ old('supported_spectrum_bands_4g') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="motherboard" id="motherboard" class="form-control @error('motherboard') is-invalid @enderror" value="{{ old('motherboard') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="motherboard_chipset_model" id="motherboard_chipset_model" class="form-control @error('motherboard_chipset_model') is-invalid @enderror" value="{{ old('motherboard_chipset_model') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="operating_system" id="operating_system" class="form-control @error('operating_system') is-invalid @enderror" value="{{ old('operating_system') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="shipment_mode" id="shipment_mode" class="form-control @error('shipment_mode') is-invalid @enderror" value="{{ old('shipment_mode') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_type" id="product_type" class="form-control @error('product_type') is-invalid @enderror" value="{{ old('product_type') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="unit_price_import" id="unit_price_import" class="form-control @error('unit_price_import') is-invalid @enderror" value="{{ old('unit_price_import') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="unit_price_mrp_bdt" id="unit_price_mrp_bdt" class="form-control @error('unit_price_mrp_bdt') is-invalid @enderror" value="{{ old('unit_price_mrp_bdt') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="marketing_period" id="marketing_period" class="form-control @error('marketing_period') is-invalid @enderror" value="{{ old('marketing_period') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="imei_tac_1" id="imei_tac_1" class="form-control @error('imei_tac_1') is-invalid @enderror" value="{{ old('imei_tac_1') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="imei_tac_2" id="imei_tac_2" class="form-control @error('imei_tac_2') is-invalid @enderror" value="{{ old('imei_tac_2') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="imei_tac_3" id="imei_tac_3" class="form-control @error('imei_tac_3') is-invalid @enderror" value="{{ old('imei_tac_3') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="imei_tac_4" id="imei_tac_4" class="form-control @error('imei_tac_4') is-invalid @enderror" value="{{ old('imei_tac_4') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="imei_1" id="imei_1" class="form-control @error('imei_1') is-invalid @enderror" value="{{ old('imei_1') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="imei_2" id="imei_2" class="form-control @error('imei_2') is-invalid @enderror" value="{{ old('imei_2') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="imei_text" id="imei_text" class="form-control @error('imei_text') is-invalid @enderror" rows="3">{{ old('imei_text') }}</textarea>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="serial_no" id="serial_no" class="form-control @error('serial_no') is-invalid @enderror" value="{{ old('serial_no') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="send_to_btrc_at" id="send_to_btrc_at" class="form-control @error('send_to_btrc_at') is-invalid @enderror" value="{{ old('send_to_btrc_at') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="btrc_update_status" id="btrc_update_status" class="form-control @error('btrc_update_status') is-invalid @enderror" value="{{ old('btrc_update_status') }}">
...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function () {
        // Initialize product_date as a date picker
        new tempusDominus.TempusDominus(document.getElementById('product_date'), {
            display: {
                viewMode: 'calendar',
                components: {
                    decades: true,
        ...
        // Initialize send_to_btrc_at as a datetime picker
        new tempusDominus.TempusDominus(document.getElementById('send_to_btrc_at'), {
            display: {
                viewMode: 'calendar',
                components: {
                    decades: true,
